...
cat /etc/rc.local | grep piranha-gui  >/dev/null 2>&1
REVAL=$?
if [ $REVAL -ne 0 ] ; then 

	echo " service piranha-gui restart ">>/etc/rc.local

fi
chmod +x /etc/sysconfig/ha/active.sh
chmod +x /etc/sysconfig/ha/inactive.sh
chmod +x /etc/sysconfig/ha/getactive.sh
chmod +x /etc/sysconfig/ha/healthstatus.sh
/sbin/service piranha-gui restart >/dev/null 2>&1
...
touch /etc/expire_quiescent_template.conf
echo "#IPVS timeout" >> /etc/expire_quiescent_template.conf
echo "net.ipv4.vs.expire_quiescent_template = 1" >> /etc/expire_quiescent_template.conf
...
%defattr(-,root,root)
/etc/sysconfig/pulse
/etc/sysconfig/ha/active.sh
/etc/sysconfig/ha/inactive.sh
/etc/sysconfig/ha/healthstatus.sh
/etc/sysconfig/ha/getactive.sh
/etc/sysconfig/ha/piranhahttp.sh
...
%config(noreplace)				/etc/sysconfig/ha/infoAgent
#%config(noreplace)				/etc/sysconfig/pulse
#%config(noreplace)				/etc/sysconfig/ha/active.sh
#%config(noreplace)				/etc/sysconfig/ha/inactive.sh
#%config(noreplace)				/etc/sysconfig/ha/getactive.sh

%attr(-,root,piranha) %config(noreplace)	/etc/sysconfig/ha/lvs.cf


%config(noreplace)				/etc/logrotate.d/piranha-httpd

%attr(-,piranha,root)				/var/log/piranha
